...
[PublicAPI]
public sealed class
    MergeComponentRequestHandler : IRequestHandler<MergeComponentRequest, IEnumerable<MergeComponent<WingmanMod>>>
{
    ...
    public Task<IEnumerable<MergeComponent<WingmanMod>>> Handle(MergeComponentRequest request,
